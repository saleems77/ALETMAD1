...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    accessInstructions: Schema.Attribute.String;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    entry_test: Schema.Attribute.Relation<
      'oneToOne',
      'api::entry-test.entry-test'
    >;
...
export interface ApiEntryTestEntryTest extends Struct.CollectionTypeSchema {
...
export interface ApiTrackTrack extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::track.track'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    numOfCourse: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
