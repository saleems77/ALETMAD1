...
export interface SharedLearningObjectives extends Struct.ComponentSchema {
  collectionName: 'components_shared_learning_objectives';
  info: {
    description: '';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ComponentSchemas {
      'shared.learning-objectives': SharedLearningObjectives;
